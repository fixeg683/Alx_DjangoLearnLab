...
def profile_photo_upload_to(instance: "User", filename: str) -> str:
    # Store as media/profile_photos/user_<id>/<filename>
...
class UserManager(BaseUserManager):
    ...
    def create_superuser(
        ...
        **extra_fields: Any,
        ...
        # Superusers can omit extra fields, but if provided, validate types
...
class Book(models.Model):
    ...
    class Meta:
        permissions = [
            ("can_view", "Can view books"),     # required by task
            ("can_create", "Can create books"), # required by task
            ("can_edit", "Can edit books"),     # required by task
            ("can_delete", "Can delete books"), # required by task
        ]
